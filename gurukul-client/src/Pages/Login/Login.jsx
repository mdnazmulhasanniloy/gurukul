...
const Login = () => {
    ...
    return (
        ...
        <div className=' w-2/4 shadow-2xl mt-5 p-10'>
                <h2 className='text-5xl font-bold my-5 text-center'>Login</h2>
            <form onSubmit={handleSubmit(onSubmit)} >
                    ...
                    <div className="h1 text-center">Don't have account <Link to='/register' className='text-blue-400 my-5'>register</Link> </div>
                    {/*Login info */}
                    {/* <div className='mt-5'>
