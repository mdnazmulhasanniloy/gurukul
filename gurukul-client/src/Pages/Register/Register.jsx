...
const Register = () => {
    ...
    const saveUser = (name, email, img) => {
        ...
        fetch(`https://gurukul-server-gules.vercel.app/users`, {
            method: 'POST',
    ...
    return (
        ...
        <div className=' w-2/4 shadow-2xl mt-5 p-10'>
                <h2 className='text-5xl font-bold my-5 text-center'>Register</h2>
                    ...
                    <div className="h1 text-center">Have a account <Link to='/login' className='text-blue-400 my-5'>Login</Link> </div>
                </div>
                </div>
    );
};
